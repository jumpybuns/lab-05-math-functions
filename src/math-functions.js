...
export function sum(a, b) {
    const s = a + b;
    const c = `The sum of ${a} and ${b} is ${s}.`;
    return [s, c];
...
//     const multABC = multiply(multArr[0], multArr[1]);
//     const finalProduct = multiply(multABC[0], multArr[2])[0];
//     const productString = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${finalProduct}.`;
...
length as its argument and returns an array whose first element is the product of those 
numbers, and the second element is a string that EXACTLY follows this example and 
